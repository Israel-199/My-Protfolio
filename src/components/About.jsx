  ...
  const socialLinks = [
    {
      name: "LinkedIn",
      icon: FiLinkedin,
      link: "https://www.linkedin.com/in/israel-assefa-b6b976358/",
    },
    {
      name: "GitHub",
      icon: FiGithub,
      link: "https://github.com/Israel-199",
    },
  ];
              ...
              <div className="bg-tertiary rounded-2xl p-6 shadow-xl">
                <div className="w-32 h-32 mx-auto mb-6 rounded-full overflow-hidden bg-secondary/20">
                  <div className="w-full h-full flex items-center justify-center text-secondary">
                    <img
                      src="assets/images/my.jpg" // or use a URL
                      alt="Israel Assefa"
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex items-center gap-2 text-textSecondary">
                    <span>📞</span>
                    <span>+251 946 002 612</span>
                  </div>
                  <div className="flex items-center gap-2 text-textSecondary">
                    <span>📧</span>
                    <span>israelassefa199@gmail.com</span>
                  </div>
                </div>
              </div>
            </motion.div>
              ...
              <div className="bg-tertiary rounded-2xl p-8 shadow-xl h-full">
                ...
                <div className="space-y-4 text-textSecondary">
                  <p>
                    ...
                    applications that are efficient and user-friendly.
                  </p>

                  <p>
                    I constantly update my skills and explore new technologies
                    to stay ahead in the ever-evolving tech landscape. I have a
                    strong passion for problem-solving and a deep dedication to
                    my work. Building high-performance digital solutions that
                    enhance user experience and drive efficiency is always a
                    priority.
                  </p>
                </div>
              </div>
