      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-5xl mx-auto">
          <div className="space-y-8 text-center md:text-left md:grid md:grid-cols-2 md:items-center md:gap-12 md:space-y-0">
            ...
            <div className="space-y-8">
              ...
              >
                ...
                <div className="flex flex-wrap gap-3 justify-center md:justify-start">
                  {["React Js", "Node Js", "Bootstrap", "Tailwind","PostgreSQL","MongoDB"].map(
                    (tech, index) => (
                      <span
                        key={tech}
            ...
            >
              <div
                className="aspect-square rounded-full bg-gradient-to-br from-secondary/20 via-secondary/10 to-transparent
                transform rotate-12 animate-pulse"
              >
                <div
                  className="absolute inset-4 rounded-full bg-gradient-to-tl from-secondary/20 via-secondary/10 to-transparent
                  transform -rotate-12"
                />
              </div>
            </motion.div>
