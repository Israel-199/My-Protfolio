...
const Testimonials = () => {
  const testimonials = [
    {
      name: "Tokuma Sime",
      position: "Owner of Maba Apparel Design",
      image: "assets/images/client1.jpg",
      content:
        "Your ability to understand my needs and deliver exactly what I wanted is commendable. Thank you!",
      rating: 5,
    },
    {
      ...
      content:
        "Working with you was a pleasure. You turned my ideas into reality with skill and precision.",
      rating: 5,
    },
    {
      name: "Tsega Endashaw",
